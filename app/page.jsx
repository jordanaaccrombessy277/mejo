  ...
  return (
    <main className="">
        ...
        <section className={`h-auto md:h-[400px] flex flex-wrap items-center p-8 md:p-16`}>
            <div className={`w-full md:w-1/2 h-auto pb-4 md:pb-0 md:pr-4`}>
            ...
            <div className={`w-full relative md:w-1/2 rounded-2xl overflow-hidden flex flex-wrap justify-center h-auto md:h-full`}>    
                    <Image className={`w-full h-full object-cover`} src={'/mejouse.png'} width="300" height="300" alt="portfolio"  /> 
            </div>
        </section>

        <section className={`h-auto bg-white rounded-lg my-7 relative z-10 px-8 py-4 w-[200px] md:w-[800px] flex flex-wrap justify-center mx-auto items-center shadow-md`}>
...
Méjo offre des rappels personnalisés pour chaque médicament.</p>
        ...
        <section id='mission' className={`h-auto bg-[#CCEBFF] flex flex-wrap items-center p-8 md:p-16`}>
            <div className={`pb-4 md:pb-0 w-full relative md:w-1/3 flex flex-wrap justify-center h-auto md:h-full`}>    
                  <Image className={`w-full h-full rounded-2xl object-cover`} src={'/mission.png'} width="300" height="300" alt="portfolio"  /> 
            </div>
            <div className={`w-full md:w-2/3 h-auto md:pl-8`}>
